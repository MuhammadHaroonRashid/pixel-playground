          ...
          >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span className="font-mono">muhammadharoonf23@nutech.edu.pk</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
                <Phone className="w-5 h-5 text-primary" />
                <span className="font-mono">+923556078187</span>
              </div>
              <div className="flex items-center gap-3 text-muted-foreground">
            ...
            <div className="flex gap-4">
              {[
                { icon: Github, href: "https://github.com/MuhammadHaroonRashid", label: "GitHub" },
                { icon: Mail, href: "mailto:muhammadharoonf23@nutech.edu.pk", label: "Email" },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.href}
